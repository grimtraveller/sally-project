////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file	SallyConfig\ThemesHelper.h
///
...
void LoadTheme(const std::string& themePath)
{
	...
	int index = hThemeView.AddItem(id, 0, name.c_str(), id, 0);
	hThemeView.AddItem(index, 1, author.c_str(), id, 0);
	hThemeView.AddItem(index, 2, version.c_str(), id, 0);
	hThemeView.AddItem(index, 3, uid.c_str(), id, 0);

	// put to list
	themeMap[id] = themePath;
