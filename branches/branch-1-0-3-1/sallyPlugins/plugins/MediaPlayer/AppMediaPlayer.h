...
private:
	...
	SallyAPI::GUI::CScreensaverControl*				m_pScreensaverControls;
	...
	SallyAPI::GUI::CScreensaverControlLabel*		m_pScreensaverControlLabelTitle;
	...
	void			OnCommandRemoveCurrentTrack();
