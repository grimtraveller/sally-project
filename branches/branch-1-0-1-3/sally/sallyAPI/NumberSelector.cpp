...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// \fn	std::string CNumberSelector::GetText()
///
/// \brief	do not use! - returns ""
///
/// \author	Christian Knobloch
/// \date	27.03.2011
///
...
std::string CNumberSelector::GetText()
{
	return "";
}

////////////////////////////////////////////////////////////////////////////////////////////////////
/// \fn	void CNumberSelector::SetText(const std::string& text)
///
/// \brief	do not use!
///
/// \author	Christian Knobloch
...
void CNumberSelector::SetText(const std::string& text)
{
	return;
}