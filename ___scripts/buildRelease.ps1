...
copy-item $startDir"sally\sally\Debug\applications\de.der-knob.sally.app.eradio\*" $startDir"sallyPlugins\plugins\eRadio\Resources\" -recurse -force

#copy-item $startDir"sallyPlugins\plugins\GuitarToolbox\Resources\*" -recurse
copy-item $startDir"sally\sally\Debug\applications\de.der-knob.sally.app.guitartoolbox\*" $startDir"sallyPlugins\plugins\GuitarToolbox\Resources\" -recurse -force

#copy-item $startDir"sallyPlugins\plugins\PartyWebCam\Resources\*" -recurse
copy-item $startDir"sally\sally\Debug\applications\de.der-knob.sally.app.partywebcam\*" $startDir"sallyPlugins\plugins\PartyWebCam\Resources\" -recurse -force

#copy-item $startDir"sallyPlugins\plugins\ServerMonitor\Resources\*" -recurse
copy-item $startDir"sally\sally\Debug\applications\de.der-knob.sally.app.servermonitor\*" $startDir"sallyPlugins\plugins\ServerMonitor\Resources\" -recurse -force

#copy-item $startDir"sallyPlugins\plugins\RabbitIsland\Resources\*" -recurse
copy-item $startDir"sally\sally\Debug\applications\de.der-knob.sally.app.rabbitisland\*" $startDir"sallyPlugins\plugins\RabbitIsland\Resources\" -recurse -force

#copy-item $startDir"sallyPlugins\plugins\Skype\Resources\*" -recurse
copy-item $startDir"sally\sally\Debug\applications\de.der-knob.sally.app.skype\*" $startDir"sallyPlugins\plugins\Skype\Resources\" -recurse -force
