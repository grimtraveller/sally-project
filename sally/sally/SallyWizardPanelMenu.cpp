	...
	:SallyAPI::GUI::CWizardPanel(parent, graphicId, pluginPath)
{
	...
	m_pLabelBox2 = new SallyAPI::GUI::CLabelBox(this, 20, 50 + CONTROL_HEIGHT + MENU_HEIGHT + 20, WIZARD_PANEL_WIDTH - 40, 150);
	...
	m_pScreensaver = new SallyAPI::GUI::CImageBox(this, 20, 280, 48, 48);
	m_pScreensaver->SetImageId(GUI_THEME_SALLY_SETTINGS);
	this->AddChild(m_pScreensaver);

	m_pLabelBox10 = new SallyAPI::GUI::CLabelBox(this, 70, 280, (WIZARD_PANEL_WIDTH / 2) - 70, 48);
	...
	m_pScreensaver = new SallyAPI::GUI::CImageBox(this, 20, 340, 48, 48);
	m_pScreensaver->SetImageId(GUI_THEME_SALLY_SCREENSAVER);
	this->AddChild(m_pScreensaver);

	m_pLabelBox11 = new SallyAPI::GUI::CLabelBox(this, 70, 340, (WIZARD_PANEL_WIDTH / 2) - 70, 48);
	...
	m_pShutdown = new SallyAPI::GUI::CImageBox(this, 20, 400, 48, 48);
	m_pShutdown->SetImageId(GUI_THEME_SALLY_LOGOUT);
	this->AddChild(m_pShutdown);

	m_pLabelBox12 = new SallyAPI::GUI::CLabelBox(this, 70, 400, (WIZARD_PANEL_WIDTH / 2) - 70, 48);
	...
	m_pShutdown = new SallyAPI::GUI::CImageBox(this, WIZARD_PANEL_WIDTH / 2 + 20, 280, 48, 48);
	m_pShutdown->SetImageId(GUI_THEME_SALLY_MINIMIZE);
	this->AddChild(m_pShutdown);

	m_pLabelBox13 = new SallyAPI::GUI::CLabelBox(this, WIZARD_PANEL_WIDTH / 2 + 70, 280, (WIZARD_PANEL_WIDTH / 2) - 70, 48);
	...
	m_pLock = new SallyAPI::GUI::CImageBox(this, WIZARD_PANEL_WIDTH / 2 + 20, 340, 48, 48);
	m_pLock->SetImageId(GUI_THEME_SALLY_LOCK);
	this->AddChild(m_pLock);

	m_pLabelBox14 = new SallyAPI::GUI::CLabelBox(this, WIZARD_PANEL_WIDTH / 2 + 70, 340, (WIZARD_PANEL_WIDTH / 2) - 70, 48);
