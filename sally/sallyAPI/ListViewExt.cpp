...
/// m_iActive(-1), m_iOldPositionX(0), m_iOldPositionY(0)
///
/// \brief	Constructor. 
///
/// \author	Christian Knobloch
...
CListViewExt::CListViewExt(SallyAPI::GUI::CGUIBaseObject* parent, int x, int y, int width, int height, 
					 ...
					 m_iRows(rows), m_iActionGraphic(actionGraphic), m_iActive(-1),
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// \fn	void CListViewExt::SetActionImageID(int icon)
///
...
void CListViewExt::SetActionImageID(int icon)
{
	if (m_iRows > 0)
	{
		for (int i = 0; i < m_iCols; ++i)
