////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file	ImageBrowser\LoadImageScreensaver.h
///
/// \brief	Declares the load image screensaver class. 
///
...
private:
	...
	virtual void RunEx();
public:
	CLoadImageScreensaver();
	virtual ~CLoadImageScreensaver();
