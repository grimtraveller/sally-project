...
std::vector<std::string> CAudioFile::GetFileExtensions()
{
	...
	if (m_FileExtensions.size() == 0)
	{
		...
		m_FileExtensions.push_back(".adt");
		m_FileExtensions.push_back(".adts");
		m_FileExtensions.push_back(".aif");
		m_FileExtensions.push_back(".aifc");
		m_FileExtensions.push_back(".aiff");
		m_FileExtensions.push_back(".au");
		m_FileExtensions.push_back(".amr");
		m_FileExtensions.push_back(".aob");
		m_FileExtensions.push_back(".ape");
		m_FileExtensions.push_back(".cda");
		m_FileExtensions.push_back(".dts");
		m_FileExtensions.push_back(".flac");
		m_FileExtensions.push_back(".it");
		m_FileExtensions.push_back(".m4a");
		m_FileExtensions.push_back(".m4p");
		m_FileExtensions.push_back(".mid");
		m_FileExtensions.push_back(".mka");
		m_FileExtensions.push_back(".mlp");
		...
		m_FileExtensions.push_back(".tta");
		m_FileExtensions.push_back(".voc");
		m_FileExtensions.push_back(".vqf");
		m_FileExtensions.push_back(".w64");
		m_FileExtensions.push_back(".wav");
		m_FileExtensions.push_back(".wma");
		m_FileExtensions.push_back(".wv");
		m_FileExtensions.push_back(".xa");
